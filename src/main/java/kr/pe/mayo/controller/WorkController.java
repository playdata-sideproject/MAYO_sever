...
public class WorkController {
    ...
    public String uploadWork(WorkDTO.Upload work, MultipartHttpServletRequest multipartHttpServletRequest) throws Exception{
        System.out.println("uploadWork ***************************");
        System.out.println(work.getCategory());
        workService.uploadWork(work, multipartHttpServletRequest);
        return "upload";
